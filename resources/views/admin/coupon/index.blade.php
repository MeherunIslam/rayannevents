                  ...
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    @foreach ($coupons as $coupon)
                      <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/coupon/edit/'.$coupon->id) }}" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                            <a href="{{ url('admin/coupon/delete/'.$coupon->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('are you sure to delete')"><i class="fa fa-trash"></i></a>
                            @if($coupon->status == 1)
