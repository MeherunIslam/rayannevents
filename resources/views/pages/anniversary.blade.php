	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s" >
				...
				<li class="active"><span> -> Others </span></li>
				<li class="active"><span> -> Wedding Anniversary </span></li>
				...
				<div class="container">
					<div class="row">
						...
						@foreach ( $categories as $cat)
								@php
									$products = App\Product::where('category_id',$cat->id)->where('category_id','=',41)->latest()->get();
								@endphp
			...
			<section class="featured spad">
				<div class="container">
					...
					<div class="row featured__filter">													
						@foreach ( $subcategories as $subcat)
							@php
								$products = App\Product::where('subcategory_id',$subcat->id)->where('category_id','=',41)->latest()->get();
							@endphp
							...
							<div class="latest-product__text">
								...
								<div class="latest-product__slider owl-carousel">
									<div class="latest-prdouct__slider__item">
										@foreach ( $categories as $cat)
											@php
												$lts_p = App\Product::where('category_id',$cat->id)->where('category_id','=',41)->limit(3)->latest()->get();
											@endphp
