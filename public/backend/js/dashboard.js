$(function(){
  ...
  var piedata = [
    { label: "Others", data: [[1,10]], color: '#677489'},
    { label: "Birthday", data: [[1,30]], color: '#218bc2'},
    { label: "Wedding", data: [[1,90]], color: '#7CBDDF'},
    { label: "Engagement", data: [[1,70]], color: '#5B93D3'},
    { label: "Wedding Anniversary", data: [[1,80]], color: '#324463'}
  ];
