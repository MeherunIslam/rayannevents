...
class ProductController extends Controller
{
    ...
    public function addProduct(){
        ...
        return view('admin.product.add',compact('categories','subcategories','groups'));
    }
    ...
    public function storeProduct(Request $request){
        ...
        Image::make($imag_one)->resize(270,270)->save('userfont/images/product/upload/'.$name_gen);       
        $img_url1 = 'userfont/images/product/upload/'.$name_gen;

        $imag_two = $request->file('image_two');                
        $name_gen = hexdec(uniqid()).'.'.$imag_two->getClientOriginalExtension();
        Image::make($imag_two)->resize(270,270)->save('userfont/images/product/upload/'.$name_gen);       
        $img_url2 = 'userfont/images/product/upload/'.$name_gen;

        $imag_three = $request->file('image_three');                
        $name_gen = hexdec(uniqid()).'.'.$imag_three->getClientOriginalExtension();
        Image::make($imag_three)->resize(270,270)->save('userfont/images/product/upload/'.$name_gen);       
        $img_url3 = 'userfont/images/product/upload/'.$name_gen;
    ...
    public function manageProduct(){
        ...
        $categories = Category::latest()->get();
        $subcategories = Subcategory::latest()->get();
        return view('admin.product.manage',compact('products','categories','subcategories'));
    }
    ...
    public function editProduct($product_id){
        ...
        $groups = Group::latest()->get();
        $subcategories = Subcategory::latest()->get();
        return view('admin.product.edit',compact('product','categories','groups','subcategories'));
    }
   ...
   public function updateImage(Request $request){
    ...
    public function viewProduct($product_id){
        ...
        $groups = Group::latest()->get();
        $subcategories = Subcategory::latest()->get();
        return view('admin.product.view',compact('product','categories','groups','subcategories'));
    }
}
